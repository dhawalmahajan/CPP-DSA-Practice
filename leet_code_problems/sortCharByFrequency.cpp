 ...
 * characters. Example: Input: cccbbbbaa Output: bbbcccaa
 *
 * Input: AaaBBaa
 * Output: aaaaBBA
 *
 ...
 *
 * Notice that order of chars in alphabatical order does not matter for same
 * frequency elements. However, also all the same characters should be together.
 * cacaca will not be a valid answer.
 */
