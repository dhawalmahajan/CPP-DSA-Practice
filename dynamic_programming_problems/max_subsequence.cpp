 ...
 *
 * We will use above approach in solving it with O(n) space and with O(1) space
 * (Kadane's approach). Special Case: If all the elements are positive then, we
 * the Maximum Value Contigous Subsequence would be the entire set
 *
 */
