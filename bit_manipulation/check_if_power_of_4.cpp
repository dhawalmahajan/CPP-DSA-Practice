 ...
 * it will have set bits at even position (as the number is power of 2, it will
 * have only one set bit.) For example: 4 (0100) 16 (0001 0000) 64 (0100 0000)
 ...
 * expression 1010 1010 1010 1010 1010 1010 1010 1010 i.e. 0xAAAAAAAA. Notice we
 * have set bits at all odd positions (it is 0 indexed), thus if expression (n &
 * 0xAAAAAAAA) == 0, then we have that set bit at even position.
 */
