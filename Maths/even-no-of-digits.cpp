/*
Description: Given an array nums of integers, return how many of them contain an
...
// we can use common logarithms (base 10) to find the number of digits of an
// integer ( number of digits = log10(n) + 1 ) C/C++ provides us with a factory
// function ( defined in < cmath > header ) to compute common log of a number.
