...
// If the data of the next node is the same as the current node then delete the
// next node. Before we delete a node, we need to store the next pointer of the
// node
