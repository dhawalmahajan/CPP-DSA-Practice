/**
 * In Quantumland, there are n cities numbered from 1 to n. Here, ci denotes the
 * ith city. There are n−1 roads in Quantumland. Here, ci and ci+1 have a
 * bidirectional road between them for each i<n. There is a rumor that Flatland
 * is going to attack Quantumland, and the queen wants to keep her land safe.
