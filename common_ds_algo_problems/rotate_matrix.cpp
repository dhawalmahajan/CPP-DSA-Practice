 ...
 *
 *  Input : First line contains M (number of rows of matrix), N (number of
 * columns in matrix) and R (Number of rotations to be performed).Then M x N
 * matrix is expected. Ouput : Matrix after R rotations.
 *
 *  Example :
 *  Input :
 *  				5 4 7
 ...
 *
 *  Approach :
 *  Accumulate each bordering rectangle in a vector, shift it R rotations and
 * copy it back to matrix. Keep doing for all levels till we have reached the
 * center of matrix.
 */
