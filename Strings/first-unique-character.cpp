/*
Description: Given a string 's', return the index of the first unique character
from the string. If not found, return -1
...
int firstUniqChar(string s) {
  ...
  map<char, int> m;
  // storing the character and its frequency in the map for every character in
  // the string
  for (char c : s) {
    m[c]++;
  }
