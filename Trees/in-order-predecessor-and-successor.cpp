...
TreeNode* predecessor(TreeNode* node, const int& data, TreeNode* value) {
  ...
  if (node->data < data) {
    return predecessor(node->right, data, node);
  } else if (node->data > data) {
    return predecessor(node->left, data, value);
  }
  return value;
}
...
TreeNode* successor(TreeNode* node, const int& data, TreeNode* value) {
  ...
  if (node->data < data) {
    return successor(node->right, data, value);
  } else if (node->data > data) {
    return successor(node->left, data, node);
  }
  return value;
}
...
int main() {
  ...
  */
  ...
  if (in_order_predecessor(root, value)) {
    std::cout << "\nPredecessor of " << value << " is "
              << in_order_predecessor(root, value)->data << std::endl;
  } else {
    std::cout << "\nNo predecessor" << std::endl;
  }

  if (in_order_successor(root, value)) {
    std::cout << "Successor of " << value << " is "
              << in_order_successor(root, value)->data << std::endl;
  } else {
